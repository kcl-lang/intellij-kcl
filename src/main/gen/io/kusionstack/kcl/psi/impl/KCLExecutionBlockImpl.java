...
public class KCLExecutionBlockImpl extends ASTWrapperPsiElement implements KCLExecutionBlock {

  public KCLExecutionBlockImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull KCLVisitor visitor) {
    visitor.visitExecutionBlock(this);
  }
