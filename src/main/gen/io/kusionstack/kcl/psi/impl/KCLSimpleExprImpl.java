...
public class KCLSimpleExprImpl extends ASTWrapperPsiElement implements KCLSimpleExpr {

  public KCLSimpleExprImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<KCLAndTest> getAndTestList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, KCLAndTest.class);
  }
