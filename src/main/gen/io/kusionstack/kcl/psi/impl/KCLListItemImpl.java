...
public class KCLListItemImpl extends ASTWrapperPsiElement implements KCLListItem {

  public KCLListItemImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @Nullable
  public KCLIfItem getIfItem() {
    return findChildByClass(KCLIfItem.class);
  }

  @Override
  @Nullable
  public KCLStarExpr getStarExpr() {
    return findChildByClass(KCLStarExpr.class);
  }
