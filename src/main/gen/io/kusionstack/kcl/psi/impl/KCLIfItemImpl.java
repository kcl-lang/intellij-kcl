...
public class KCLIfItemImpl extends ASTWrapperPsiElement implements KCLIfItem {

  public KCLIfItemImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull KCLVisitor visitor) {
    visitor.visitIfItem(this);
  }
  ...
  @Override
  @NotNull
  public List<KCLIfItemExecBlock> getIfItemExecBlockList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, KCLIfItemExecBlock.class);
  }
