...
public class KCLListExprImpl extends ASTWrapperPsiElement implements KCLListExpr {

  public KCLListExprImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @Nullable
  public KCLListItems getListItems() {
    return findChildByClass(KCLListItems.class);
  }
