...
public class KCLDecoratorExprImpl extends ASTWrapperPsiElement implements KCLDecoratorExpr {

  public KCLDecoratorExprImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @Nullable
  public KCLCallSuffix getCallSuffix() {
    return findChildByClass(KCLCallSuffix.class);
  }
