...
public class KCLMixinsImpl extends ASTWrapperPsiElement implements KCLMixins {

  public KCLMixinsImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull KCLVisitor visitor) {
    visitor.visitMixins(this);
  }
  ...
  @Override
  @NotNull
  public List<KCLMixins> getMixinsList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, KCLMixins.class);
  }
