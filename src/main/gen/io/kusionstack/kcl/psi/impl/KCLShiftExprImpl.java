...
public class KCLShiftExprImpl extends ASTWrapperPsiElement implements KCLShiftExpr {

  public KCLShiftExprImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<KCLArithExpr> getArithExprList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, KCLArithExpr.class);
  }
