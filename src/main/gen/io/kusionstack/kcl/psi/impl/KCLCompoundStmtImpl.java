...
public class KCLCompoundStmtImpl extends ASTWrapperPsiElement implements KCLCompoundStmt {

  public KCLCompoundStmtImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @Nullable
  public KCLSchemaStmt getSchemaStmt() {
    return findChildByClass(KCLSchemaStmt.class);
  }
