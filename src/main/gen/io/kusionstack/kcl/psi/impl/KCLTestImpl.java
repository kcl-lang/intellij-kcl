...
public class KCLTestImpl extends ASTWrapperPsiElement implements KCLTest {

  public KCLTestImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @Nullable
  public KCLIfExpr getIfExpr() {
    return findChildByClass(KCLIfExpr.class);
  }

  @Override
  @Nullable
  public KCLSimpleExpr getSimpleExpr() {
    return findChildByClass(KCLSimpleExpr.class);
  }
