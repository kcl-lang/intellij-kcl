...
public class KCLIfEntryImpl extends ASTWrapperPsiElement implements KCLIfEntry {

  public KCLIfEntryImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull KCLVisitor visitor) {
    visitor.visitIfEntry(this);
  }
  ...
  @Override
  @NotNull
  public List<KCLIfEntryExecBlock> getIfEntryExecBlockList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, KCLIfEntryExecBlock.class);
  }
