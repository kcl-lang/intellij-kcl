...
public class KCLDotNameImpl extends ASTWrapperPsiElement implements KCLDotName {

  public KCLDotNameImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull KCLVisitor visitor) {
    visitor.visitDotName(this);
  }
  ...
  @Override
  @Nullable
  public KCLLeadingDots getLeadingDots() {
    return findChildByClass(KCLLeadingDots.class);
  }
