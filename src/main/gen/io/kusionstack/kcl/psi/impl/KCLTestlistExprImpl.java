...
public class KCLTestlistExprImpl extends ASTWrapperPsiElement implements KCLTestlistExpr {

  public KCLTestlistExprImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull KCLVisitor visitor) {
    visitor.visitTestlistExpr(this);
  }
