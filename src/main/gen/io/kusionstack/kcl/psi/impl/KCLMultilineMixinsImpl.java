...
public class KCLMultilineMixinsImpl extends ASTWrapperPsiElement implements KCLMultilineMixins {

  public KCLMultilineMixinsImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull KCLVisitor visitor) {
    visitor.visitMultilineMixins(this);
  }
  ...
  public KCLMixins getMixins() {
    return findNotNullChildByClass(KCLMixins.class);
  }
