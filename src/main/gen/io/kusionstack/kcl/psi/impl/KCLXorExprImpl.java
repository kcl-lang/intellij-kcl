...
public class KCLXorExprImpl extends ASTWrapperPsiElement implements KCLXorExpr {

  public KCLXorExprImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<KCLAndExpr> getAndExprList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, KCLAndExpr.class);
  }
