...
public class KCLLeadingDotsImpl extends ASTWrapperPsiElement implements KCLLeadingDots {

  public KCLLeadingDotsImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull KCLVisitor visitor) {
    visitor.visitLeadingDots(this);
  }
