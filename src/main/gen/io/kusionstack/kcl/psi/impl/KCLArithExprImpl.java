...
public class KCLArithExprImpl extends ASTWrapperPsiElement implements KCLArithExpr {

  public KCLArithExprImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<KCLTerm> getTermList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, KCLTerm.class);
  }
