...
public class KCLImportStmtImpl extends ASTWrapperPsiElement implements KCLImportStmt {

  public KCLImportStmtImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @Nullable
  public KCLDotName getDotName() {
    return findChildByClass(KCLDotName.class);
  }
