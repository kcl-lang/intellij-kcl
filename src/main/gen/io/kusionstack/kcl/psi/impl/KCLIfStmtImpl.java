...
public class KCLIfStmtImpl extends ASTWrapperPsiElement implements KCLIfStmt {

  public KCLIfStmtImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<KCLExecutionBlock> getExecutionBlockList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, KCLExecutionBlock.class);
  }
